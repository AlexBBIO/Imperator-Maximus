...
**▶ [PLAY IN YOUR BROWSER](https://alexbbio.github.io/Imperator-Maximus/)** — no install. Deployed to GitHub Pages automatically on every push (see `.github/workflows/pages.yml`).
